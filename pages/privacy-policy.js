...
const PrivacyPolicy = () => (
  <>
    <Head>
      <title>
        Privacy Policy - Leckere Koreanische Rezepte & HansikYoungRecipes
      </title>
      <meta
        name="description"
        content="Read our Privacy Policy to understand how we handle your personal data on Leckere Koreanische Rezepte and HansikYoungRecipes."
      />
    </Head>
    <div className={styles.container}>
      ...
      <h2 className={styles.heading2}>Interpretation and Definitions</h2>
      <h3 className={styles.heading3}>Interpretation</h3>
      <p className={styles.paragraph}>
      ...
      <h3 className={styles.heading3}>Definitions</h3>
      <p className={styles.paragraph}>
      ...
      <ul className={styles.list}>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to HansikYoungRecipes, the
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Leckere Koreanische
            Rezepte & HansikYoungRecipes.
          </p>
        </li>
        <li>
          <p>
      ...
      <h3 className={styles.heading3}>Types of Data Collected</h3>
      <h4 className={styles.heading4}>Personal Data</h4>
      <p className={styles.paragraph}>
      ...
      <h4 className={styles.heading4}>Usage Data</h4>
      <p className={styles.paragraph}>
      ...
      <h3 className={styles.heading3}>Use of Your Personal Data</h3>
      <p className={styles.paragraph}>
      ...
      <h3 className={styles.heading3}>Retention of Your Personal Data</h3>
      <p className={styles.paragraph}>
      ...
      <h3 className={styles.heading3}>Transfer of Your Personal Data</h3>
      <p className={styles.paragraph}>
      ...
      <h3 className={styles.heading3}>Delete Your Personal Data</h3>
      <p className={styles.paragraph}>
      ...
      <h3 className={styles.heading3}>Disclosure of Your Personal Data</h3>
      <h4 className={styles.heading4}>Business Transactions</h4>
      <p className={styles.paragraph}>
      ...
      <h4 className={styles.heading4}>Law enforcement</h4>
      <p className={styles.paragraph}>
      ...
      <h4 className={styles.heading4}>Other legal requirements</h4>
      <p className={styles.paragraph}>
      ...
      <h3 className={styles.heading3}>Security of Your Personal Data</h3>
      <p className={styles.paragraph}>
      ...
      <h2 className={styles.heading2}>Children's Privacy</h2>
      <p className={styles.paragraph}>
      ...
      <h2 className={styles.heading2}>Links to Other Websites</h2>
      <p className={styles.paragraph}>
      ...
      <ul className={styles.list}>
        <li>By email: joan.korean.rezepte@gmail.com</li>
      </ul>
    </div>
  </>
);
