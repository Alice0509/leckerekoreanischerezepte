const INGREDIENT_SLUG_DEFINITIONS = [
  {
    primaryEntryId: '5iNckOu7Z7kE3cVK0j0Sp7',
    memberEntryIds: ['5iNckOu7Z7kE3cVK0j0Sp7'],
    slug: 'yangjo-ganjang',
    aliases: [
      '-gebraute-sojasosse',
      'gebraute-sojasosse',
  ...
  {
    primaryEntryId: '4vprY0juk4B316lNrFaBjW',
    memberEntryIds: ['4vprY0juk4B316lNrFaBjW'],
    slug: 'soybean-sprouts',
    aliases: ['sojabohnensprossen', 'Sojabohnensprossen', 'Soybean sprouts'],
  },
  {
  ...
  {
    primaryEntryId: '3pxIpo3j2wLFFl5lzgsdFm',
    memberEntryIds: ['3pxIpo3j2wLFFl5lzgsdFm'],
    slug: 'daepa',
    aliases: ['Daepa'],
  },
  {
    primaryEntryId: '6g42vVsU6ryPS65cHmIkTl',
    memberEntryIds: ['6g42vVsU6ryPS65cHmIkTl'],
    slug: 'minced-garlic',
    aliases: ['MincedGarlic'],
  },
  {
    primaryEntryId: '6T98N3gW2KqiAuFtiQInG5',
    memberEntryIds: ['6T98N3gW2KqiAuFtiQInG5'],
    slug: 'egg',
    aliases: ['Egg'],
  },
  {
    primaryEntryId: '6MvnL7q2uoQv5tGRbFiD5Q',
    memberEntryIds: ['6MvnL7q2uoQv5tGRbFiD5Q'],
    slug: 'corn-syrup',
    aliases: ['Corn-syrup'],
  },
  {
    primaryEntryId: '4RZt5qRnrpQScVLsgKbEDo',
    memberEntryIds: ['4RZt5qRnrpQScVLsgKbEDo'],
    slug: 'fried-egg',
    aliases: ['Spiegelei', 'Fried egg'],
  },
  {
    primaryEntryId: '5jDfXG6zL1DQLgM3pu2Q8B',
    memberEntryIds: ['5jDfXG6zL1DQLgM3pu2Q8B'],
    slug: 'minced-beef',
    aliases: ['Rinderhackfleisch', 'Minced beef'],
  },
  {
    primaryEntryId: 'ngCjJZckmnJA0Tx71gJiK',
    memberEntryIds: ['ngCjJZckmnJA0Tx71gJiK'],
    slug: 'pine-nuts',
    aliases: ['Pinienkerne', 'Pine nuts'],
  },
  {
    primaryEntryId: '1RBkMvqmpE3s6T8n4oJD29',
    memberEntryIds: ['1RBkMvqmpE3s6T8n4oJD29'],
  ...
  {
    primaryEntryId: '6b4beb2fxBtvsjDwcNph9y',
    memberEntryIds: ['6b4beb2fxBtvsjDwcNph9y'],
    slug: 'cornstarch',
    aliases: ['Cornstarch'],
  },
  {
    primaryEntryId: '6YXoD4lWzBKjUw7qIdHYyL',
    memberEntryIds: ['6YXoD4lWzBKjUw7qIdHYyL'],
    slug: 'flour',
    aliases: ['Mehl'],
  },
  {
    primaryEntryId: 'cJOwiDCrQGDb4LIN56Kjr',
    memberEntryIds: ['cJOwiDCrQGDb4LIN56Kjr'],
    slug: 'mirim',
    aliases: ['Mirim'],
  },
  {
    primaryEntryId: '11InF0pY9EuDGSj7ZLDwdJ',
    memberEntryIds: ['11InF0pY9EuDGSj7ZLDwdJ'],
    slug: 'nuts',
    aliases: ['Nuts'],
  },
  {
    primaryEntryId: '6cKgFvudIlQgrEaWmlfG1S',
    memberEntryIds: ['6cKgFvudIlQgrEaWmlfG1S'],
    slug: 'nashi-pear',
    aliases: ['Pear', 'pear'],
  },
  {
    primaryEntryId: '5l1iUprK1Pxt47O8m8cpWY',
    memberEntryIds: ['5l1iUprK1Pxt47O8m8cpWY'],
    slug: 'shiitake-mushrooms',
    aliases: ['Shiitake', 'shiitake'],
  },
  {
    primaryEntryId: '3ybhkfB2FuBnXCwIQqYVOd',
    memberEntryIds: ['3ybhkfB2FuBnXCwIQqYVOd'],
    slug: 'azuki-beans',
    aliases: ['Azuki-Bohnen', 'azuki-bohnen'],
  },
];
